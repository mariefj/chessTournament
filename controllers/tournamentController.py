...
class TournamentController():
	...
	def sort_round(self, list_players, sort_type):
		...
		if sort_type == "rank":
			return sorted(list_players_for_round, key=lambda i: (i.rank, i.doc_id), reverse=True)
		else:
			return sorted(list_players_for_round, key=lambda i: (i.score, i.rank), reverse=True)
	...
	def get_players_display_games(self, list_games):
	...
	def manage_end_tournament(self, tournament):
		self.reset_score_players(tournament.list_rounds, tournament.nb_rounds, tournament.list_players)
	...
	def get_list_games(self, list_players, list_rounds):
		...
		if list_rounds == []:
			...
			self.get_list_games_next_rounds(list_games, list_players, list_all_pairs)
